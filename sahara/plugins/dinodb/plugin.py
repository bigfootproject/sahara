...
class DiNoDBProvider(p.ProvisioningPluginBase):
    def __init__(self):
        self.processes = {
    ...
    def get_description(self):
        return _("This plugin provides an ability to launch DiNoDB with"
                 " Spark on an Hadoop CDH cluster without any management"
                 " consoles.")
    ...
    def _push_configs_to_new_node(self, cluster, extra, instance):
        ...
        with remote.get_remote(instance) as r:
            ...
            #r.execute_command('sudo apt-get update; sudo apt-get install libpq-dev -y')
